...
class ResNet3D(nn.Module):
    ...
    def __init__(
        ...
        drop_rate: float = 0.0,
        kernel_size=7,  # Can be set to (3, 7, 7),
        stride=2,  # Can be set to (1, 2, 2)
        ...
        stage_modules, stage_feature_info = make_blocks(
            ...
            reduce_params_in_layers=reduce_params_in_layers,
            avg_down=avg_down,
